...
import { runScraper, stopScraper, getCategories } from '../api/client';
  ...
  return (
    <div className="min-h-[calc(100vh-6rem)] flex flex-col items-center justify-center py-8 animate-fade-in">
      <div className="w-full max-w-lg mx-auto px-4">
        <h1 className="text-2xl font-semibold text-stone-100 text-center mb-8 animate-fade-in-up" style={fieldDelay(0)}>
          Collect Data
        </h1>
        <div
